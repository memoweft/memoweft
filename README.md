...
| ---------------------------------------------------------------------------------------------------- | -------------------------------------------- | ------------------------------------------------- |
| [Vercel AI SDK](https://github.com/memoweft/memoweft/tree/main/packages/adapter-ai-sdk)              | Middleware recall and controlled persistence | npm `0.2.3`: Core `0.5.1` / `0.6` / `0.7` / `1.x` |
| [Model Context Protocol](https://github.com/memoweft/memoweft/tree/main/packages/mcp-server)         | Stdio: 5 reads and 3 controlled writes       | npm `0.2.3`: Core `0.5.1` / `0.6` / `0.7` / `1.x` |
...
The two published integrations — `@memoweft/adapter-ai-sdk@0.2.3` and `@memoweft/mcp-server@0.2.3` — install with Core `0.5.1`, `0.6`, `0.7`, the 1.0 RC series, and final 1.x releases. Source-preview integrations are available for evaluation from this repository and are not presented as npm-installable until released.
